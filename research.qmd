...
Conceptual simplicity is important in human-centered data science. Using simple causal models as hypotheses allows people to ask the questions they really care about, make their assumptions transparent, and communicate clearly to broad audiences. I made a case for some of these benefits in a recent [position paper](https://proceedings.mlr.press/v235/loftus24a.html) (ICML 2024).

My first works in this area focused on fair machine learning and algorithmic discrimination. With the paper [Counterfactual Fairness](https://proceedings.neurips.cc/paper_files/paper/2017/hash/a486cd07e4ac3d270571622f4f316ec5-Abstract.html) (NeurIPS 2017) my co-authors and I helped start a growing, interdisciplinary research field of causal fairness. See this [Nature Comment](https://www.nature.com/articles/d41586-020-00274-3) for a high level overview.
